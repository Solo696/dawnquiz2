        ...
        {tab === "create" && !created && (
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: "0.4rem" }}>
                {[{v:6,l:"6h"},{v:12,l:"12h"},{v:24,l:"24h"},{v:48,l:"48h"},{v:72,l:"3 days"},{v:168,l:"1 week"}].map(d => (
                  <button key={d.v} onClick={() => setCreateHours(d.v)} style={{
                    flex: 1, padding: "0.5rem 0.25rem", borderRadius: 10, fontFamily: "inherit", cursor: "pointer",
                    border: `1.5px solid ${createHours === d.v ? T.purple : T.borderHigh}`,
                    background: createHours === d.v ? "#1a0e3a" : T.surface,
                    color: createHours === d.v ? "#c4b5fd" : T.textMuted,
                    fontSize: "0.8rem", fontWeight: createHours === d.v ? 800 : 500,
                  }}>{d.l}</button>
                ))}
              </div>
            </div>
