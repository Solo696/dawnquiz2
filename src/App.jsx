...
function AdminPanel({ player, dispatch, onExit, currentAdmin, adminsHook, navLabels, setNavLabels, announcements = [], saveAnnouncements }) {
    ...
    <div style={css.screen}>
      <div style={{ padding: "1.25rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.4rem", marginBottom: "1.25rem" }}>
          {[["questions","❓ Questions"],["announcements","📢 Announce"],["archive","📋 Archive"],["modules","📚 Modules"],["labels","✏️ Labels"],["reports","⚑ Reports"],["feedback","💬 Feedback"],["admins","👥 Admins"]].map(([k, l]) => (
...
function Home({ player, onNav, onAdminClick, navLabels, setNavLabels, announcements = [] }) {
  const rank = getRank(player.sunrays);
  const next = getNextRank(player.sunrays);
  const prog = next ? ((player.sunrays - rank.threshold) / (next.threshold - rank.threshold)) * 100 : 100;
...
export default function App() {
  ...
  const views = {
    home:        <Home player={player} onNav={setScreen} onAdminClick={handleAdminClick} navLabels={navLabels} setNavLabels={setNavLabels} announcements={activeAnnouncements} />,
    ...
    admin:       <AdminPanel player={player} dispatch={dispatch} onExit={() => { setScreen("home"); setCurrentAdmin(null); }} currentAdmin={currentAdmin} adminsHook={adminsHook} navLabels={navLabels} setNavLabels={setNavLabels} announcements={announcements} saveAnnouncements={saveAnnouncements} />,
  };
